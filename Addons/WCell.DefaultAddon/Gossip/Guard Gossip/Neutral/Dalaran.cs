...
namespace WCell.Addons.Default.Gossip.GuardGossip.Neutral
{
    class Dalaran : GossipMenu
    {
        ...
        public static void LoadDalaranMenu()
        {
            ...
            CreateDalaranGossipMenu(32680);
            CreateDalaranGossipMenu(32681);
            CreateDalaranGossipMenu(32685);
            CreateDalaranGossipMenu(32688);
            CreateDalaranGossipMenu(32689);
            CreateDalaranGossipMenu(32691);
        }

        public static void CreateDalaranGossipMenu(uint npcID)
        {
